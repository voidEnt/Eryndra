...
| `MAP-004` | Map | Brackenford - Survey Office | Prologue | CORE | `Map004.json` | `PRO-SC-004`, `010` | Implemented | Mapping + Eventwright independently static PASS; MZ runtime pending |
...
| `MAP-004` | 4 | Brackenford - Survey Office | `MAP-003` | `PRO-SC-004`, `010` | CORE | Implemented candidate — static Mapping/Eventwright PASS; runtime pending |
