...
| `MAP-004` | Map | Brackenford - Survey Office | Prologue | CORE | `Map004.json` | `PRO-SC-004`, `010` | Assigned | Mapping Pass 03 independently static PASS; Eventwright/runtime pending |
...
| `MAP-004` | 4 | Brackenford - Survey Office | `MAP-003` | `PRO-SC-004`, `010` | CORE | Assigned — Mapping Pass 03 independent static PASS; Eventwright pending |
